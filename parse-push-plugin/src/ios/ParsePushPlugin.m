...
//     [Parse setApplicationId:[command.arguments objectAtIndex:0] clientKey:[command.arguments objectAtIndex:1]];
...
// - (void)initializeParseServer: (CDVInvokedUrlCommand*)command {    
//   [self.commandDelegate runInBackground: ^{
//     [Parse initializeWithConfiguration:[ParseClientConfiguration configurationWithBlock:^(id<ParseMutableClientConfiguration> configuration) {
//       configuration.applicationId = [command.arguments objectAtIndex:0];
//       configuration.clientKey = @"clientKey";
//       configuration.server = [command.arguments objectAtIndex:1];
//       CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK];
//       [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];      
//     }]];      
//   }];
