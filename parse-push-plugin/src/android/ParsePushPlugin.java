...
public class ParsePushPlugin extends CordovaPlugin {
    ...
    // public static final String ACTION_INITIALIZE_PARSESERVER = "initializeParseServer";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
      ...
      //   this.initialize(args.getString(0),args.getString(1), callbackContext);
      //   return true;
      // }
      
      // if (action.equals(ACTION_INITIALIZE_PARSESERVER)) {
      //   this.initializeParseServer(args.getString(0),args.getString(1), callbackContext);
      //   return true;        
      // }
    ...
    // private void initialize(final String appId,final String clientKey, final CallbackContext callbackContext) {
    // 	Parse.initialize(cordova.getActivity(), appId, clientKey);
    //   callbackContext.success();
    // }

    // private void initializeParseServer(final String appId,final String serverUrl, final CallbackContext callbackContext) {
