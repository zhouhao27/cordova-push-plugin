...
var ParsePushPlugin = {
    ...
    // TODO: not working for Android, need to find out a solution
    ...
    // initializeParseServer: function(appId,serverUrl,successCb, errorCb) {
    //   cordova.exec(successCb, errorCb, serviceName, 'initializeParseServer', [appId,serverUrl]);
    // },
